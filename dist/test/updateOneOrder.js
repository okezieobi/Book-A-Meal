...
describe('Test endpoint at "/v1/orders/:id" to update or create a menu order', function () {
  ...
  it('should not update amenu order at "/v1/orders" with PUT if customer name does not exist and menu order exists',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if customer name and menu order do NOT exist',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if customer name is an empty string and menu order exists',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if customer name is an empty string and menu order does not exist',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if customer name are not letters and menu order exists',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if customer name are not letters and menu order does NOT exist',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if menu list does not exist and menu order exists',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if menu list and menu order do not exist',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if menu list is an empty string and menu order exists',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if menu list is an empty string and menu order does not exist',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  ...
  it('should not update amenu order at "/v1/orders" with PUT if menu list are not letters and menu order exists',
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
